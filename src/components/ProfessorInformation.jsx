...
function ProfessorInformation({ email, phone, address, academic_title, specialization, contract_date }) {
  ...
  return (
    <div className="py-8 flex flex-col justify-start gap-3 pl-2 border-l-2 border-black">
      {email && (
      ...
      {academic_title && (
        <div className="flex items-center gap-3">
          ...
          <p className='font-semibold text-lg'>{academic_title}</p>
        </div>
      )}
      ...
      {contract_date && (
        <div className="flex items-center gap-3">
          ...
          <p className='font-semibold text-lg'>Contratado el {contract_date}</p>
        </div>
      )}
    </div>
  )
